...
import {addSingleTask} from '../../features/Tasks/TasksSlice';
      ...
      try {
        ...
        try {
          ...
          if (response.status === 201) {
            showToast(
              'Task Created 🚀',
              'Your task has been created 🥳, redirecting to tasks screen..!',
              'success',
            );
            setTimeout(() => {
    ...
    <ScrollView
      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.infoText}>Create new task</Text>
          <TouchableOpacity />
        </View>
